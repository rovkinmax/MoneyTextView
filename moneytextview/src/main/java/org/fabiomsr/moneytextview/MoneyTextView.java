...
public class MoneyTextView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            mSymbolSection.text = typedArray.getString(R.styleable.MoneyTextView_mtSymbol);
            mAmount = typedArray.getFloat(R.styleable.MoneyTextView_mtAmount, 0);
            mGravity = typedArray.getInt(R.styleable.MoneyTextView_mtGravity, GRAVITY_CENTER_VERTICAL | GRAVITY_CENTER_HORIZONTAL);
            ...
            String format = typedArray.getString(R.styleable.MoneyTextView_mtFormat);
    ...
    private static class Section {
        ...
        private void calculateBounds(TextPaint paint) {
        ...
        private void calculateNumbersHeight(TextPaint paint) {
